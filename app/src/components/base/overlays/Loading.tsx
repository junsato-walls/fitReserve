...
import { Z_INDEX, type Size, type Tone } from "@/components/base/tokens"
    ...
    (
        ...
        const loadingContent = (
            ...
            >
                ...
                <div
                    className={cn(
                        "bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8 mx-4 max-w-sm w-full text-center transform transition-all duration-200",
                    )}
