...
import { Z_INDEX, type Tone } from "@/components/base/tokens"
    ...
    (
            ...
            switch (tone) {
                case "info":
                    return {
                        ...
                        arrow: "bg-blue-600 dark:bg-blue-500",
                    }
                case "success":
                    return {
        ...
        const clonedTriggerElement = isValidElement(triggerElement)
            ? cloneElement(triggerElement, {
                  ref: (node: HTMLElement | null) => {
                      ...
                      // 元のrefも保持 - 型安全にアクセス
                      const elementWithRef = triggerElement as ReactElement & {
                          ref?: React.Ref<HTMLElement>
                      }
        ...
        const tooltipContent = isVisible ? (
            <div
                ...
                role="tooltip"
                className={cn(
                    "absolute inline-block px-3 py-2 text-sm font-medium transition-opacity duration-300 rounded-lg shadow-sm",
                    toneStyles.tooltip,
            ...
            >
                ...
                {arrow && (
                    <div
                        className={cn(arrowStyles.classes, arrowStyles.position, toneStyles.arrow)}
                        data-popper-arrow
                    />
                )}
            </div>
