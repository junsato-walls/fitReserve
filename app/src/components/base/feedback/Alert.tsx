...
export const Alert = forwardRef<HTMLDivElement, AlertProps>(
    (
        ...
        const getToneStyles = () => {
            const styles = {
                info: {
                    ghost: "text-blue-800 dark:text-blue-400",
                    soft: "text-blue-800 bg-blue-50 dark:bg-gray-800 dark:text-blue-400",
                    filled: "text-white bg-blue-600 dark:bg-blue-600",
                    outlined:
                        "text-blue-800 border border-blue-300 bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800",
                ...
                success: {
                    ghost: "text-green-800 dark:text-green-400",
                ...
                warning: {
                    ghost: "text-yellow-800 dark:text-yellow-300",
                ...
                danger: {
                    ghost: "text-red-800 dark:text-red-400",
                ...
                neutral: {
                    ghost: "text-gray-800 dark:text-gray-300",
            ...
            >
                ...
                {dismissible && (
                    <button
                        ...
                        className={cn(
                            "ms-auto -mx-1.5 -my-1.5 rounded-lg focus:ring-2 p-1.5 inline-flex items-center justify-center h-8 w-8 transition-colors duration-150",
                            variant === "filled"
