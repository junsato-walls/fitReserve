...
export default function Pagination({
    ...
    `;
        ...
        const positionClasses = {
            first: 'ms-0 border border-e-0 border-gray-300 rounded-s-lg',
            last: 'border border-gray-300 rounded-e-lg',
            middle: 'border border-gray-300',
        };
    ...
    `;
        ...
        const pageNumber = typeof page === 'number' ? page :
    ...
    return (
        <nav aria-label="Page navigation" className={className}>
            <ul className={`inline-flex -space-x-px ${sizeClasses[size].container}`}>
                {/* First ボタン */}
                {showFirstLast && (
                    renderPageItem(
                        'first',
