...
export const Carousel = forwardRef<HTMLDivElement, CarouselProps>(
    (
        ...
        return (
            ...
            >
                {/* Carousel wrapper */}
                <div className={cn("relative", getHeightClasses(), "overflow-hidden rounded-lg")}>
