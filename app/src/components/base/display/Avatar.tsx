...
export const Avatar = forwardRef<HTMLDivElement, AvatarProps>(({
    ...
    const getStatusClasses = () => {
        ...
        const statusClasses = {
            online: 'bg-green-400 dark:bg-green-600',
            offline: 'bg-gray-400 dark:bg-gray-500',
            away: 'bg-yellow-400 dark:bg-yellow-600',
            busy: 'bg-red-400 dark:bg-red-600'
        } as const;
    ...
    const getInitialsBackgroundColor = () => {
        ...
        const colors = [
            ...
            'bg-purple-500 dark:bg-purple-600', 'bg-pink-500 dark:bg-pink-600', 'bg-indigo-500 dark:bg-indigo-600', 'bg-teal-500'
        ] as const;
    ...
    return (
        ...
        >
            ...
            {shouldShowFallback && (
                <div
                    className={`
                        flex items-center justify-center bg-gray-300 dark:bg-gray-600 text-gray-600 dark:text-gray-300 font-medium
                        ${sizeClasses.container}
                        ${sizeClasses.text}
                        ${shapeClasses}
                        ${variantClasses}
