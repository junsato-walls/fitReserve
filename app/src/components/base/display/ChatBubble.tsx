...
export const ChatBubble = forwardRef<HTMLDivElement, ChatBubbleProps>(({
    ...
    const renderAttachment = (attachment: ChatAttachment) => {
        switch (attachment.type) {
            ...
            case 'file':
                return (
                    <div key={attachment.id} className="mt-2 p-3 bg-white/10 dark:bg-gray-800/10 rounded-lg flex items-center space-x-3">
            ...
            case 'link':
                return (
                    <div key={attachment.id} className="mt-2 p-3 bg-white/10 dark:bg-gray-800/10 rounded-lg">
