    ...
    (
            ...
            switch (variant) {
                case "underline":
                    return {
                        ...
                        tab: "inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:border-gray-600 dark:hover:text-gray-300",
                        activeTab:
        ...
        return (
            <div ref={ref} className={cn("w-full")}>
                {/* タブリスト */}
                <ul
                    className={cn(variantStyles.tabList, fullWidth ? "w-full" : "")}
                    role="tablist"
                    aria-label={ariaLabel}
                ...
                >
                    {tabs.map((tab, index) => {
                        ...
                        ${isDisabled ? `${variantStyles.disabledTab}` : ""}
                        ${fullWidth ? "flex-1" : ""}
                    ...
                    `.trim()
                        ...
                        return (
                            <li
                                key={tab.id}
                                className={
                                    fullWidth ? "flex-1" : index === tabs.length - 1 ? "" : "me-2"
                                }
                            >
                                {tab.href && !isDisabled ? (
                                    <a
