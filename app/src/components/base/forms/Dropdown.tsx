...
export const Dropdown = <T extends string | number,>({
    ...
    const defaultIcon = (
        <svg
            className={`${sizeClasses[size].iconSize} ms-3`}
            aria-hidden="true"
        ...
        <div ref={containerRef} className="relative inline-block text-left">
            ...
            {trigger ? (
                ...
                <button
                    ...
                    className={`
            font-medium rounded-lg focus:ring-4 focus:outline-none text-center inline-flex items-center
          ...
          `}
                >
                    <ul className={`py-2 ${sizeClasses[size].menu} text-gray-700 dark:text-gray-200`}>
                            ...
                            return (
                                ...
                                <li key={item.id} role="none">
                                    <a
                                        ...
                                        onMouseEnter={() => !item.disabled && setFocusedIndex(validIndex)}
